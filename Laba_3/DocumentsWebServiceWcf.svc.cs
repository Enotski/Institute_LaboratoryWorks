...
namespace Laba_3
{
    // ПРИМЕЧАНИЕ. Команду "Переименовать" в меню "Рефакторинг" можно использовать для одновременного изменения имени класса "DocumentsWebServiceWcf" в коде, SVC-файле и файле конфигурации.
    // ПРИМЕЧАНИЕ. Чтобы запустить клиент проверки WCF для тестирования службы, выберите элементы DocumentsWebServiceWcf.svc или DocumentsWebServiceWcf.svc.cs в обозревателе решений и начните отладку.
